    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderImportancies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersAddresses_Governorate_GovernorateID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryPromotions", x => new { x.PromotionId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAddressesList", x => new { x.UserId, x.AddressId });
                    table.ForeignKey(
                        name: "FK_UserAddressesList_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAddressesList_UsersAddresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteListItems", x => new { x.ProductItemId, x.UserId });
                    table.ForeignKey(
                        name: "FK_FavouriteListItems_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavouriteListItems_ProductItem_ProductItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderLines_ProductItem_ProductItemId",
                        column: x => x.ProductItemId,
                        principalTable: "ProductItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductItemReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductItemReviews_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductItemReviews_OrderLines_OrderLineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavouriteListItems_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItemReviews_OrderLineId",
                table: "ProductItemReviews",
                column: "OrderLineId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductItemReviews_UserId",
                table: "ProductItemReviews",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersAddresses_GovernorateID",
